    ...
    <PageContainer className="">
      ...
      <div className="max-w-6xl mx-auto bg-white relative">
        ...
        <div className="flex flex-wrap w-full flex-col items-center px-4 space-y-5 mx-auto overflow-hidden text-center">
          ...
          <h1 className="font-bold text-xl">Barrack Obama</h1>
          {/* Edit Profile Button */}
          <button className="flex items-center space-x-2 p-2 px-3 text-xs text-white bg-darkGray self-center rounded-md outline-none focus:outline-none transform transition hover:scale-110 active:scale-75">
          ...
          <div className="flex flex-col relative border border-gray-100 max-w-2xl overflow-hidden rounded-md">
            ...
            {/* <textarea className="text-sm text-gray-600 text-center outline-none p-5 w-full h-full"></textarea> */}
          </div>
